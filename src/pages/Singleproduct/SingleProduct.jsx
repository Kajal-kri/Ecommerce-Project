...
const SingleProduct = ({addToCart}) => {
  ...
  return (
    <>
    {/* <div className='flex gap-4 items-center w-30 border py-2 px-4 mx-auto '>
      <FaLongArrowAltLeft />
      <button className='text-center'>Back</button>
    </div> */}
    <section className="text-gray-600 body-font overflow-hidden ">
  <div className="container px-5 py-24 mx-auto relative">
  <div className='flex gap-4 items-center w-30 py-2 px-4 absolute top-7 lg:left-30 mx-auto text-blue-800' onClick={()=>navigate('/allproduct')}>
      <FaLongArrowAltLeft size={24}/>
      <button className='text-xl'>Back</button>
    </div>
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-100 h-64 object-contain object-center rounded border" src={singleProduct.thumbnail}/>
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="flex mt-6">
          ...
          <button className="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded" onClick={addtoSingleProduct}>Add to card</button>
    ...
    //  <img src={singleProduct.thumbnail} alt='thumbnail' classNameName='mx-auto h-[150px] w-full object-contain'/>
    // </div>
  )
}
